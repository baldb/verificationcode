package com.utils.verificationcode.utils;
...
public class CreateVerificationCodeImage {
    ...
    private static int WIDTH = 180;//90
    private static int HEIGHT = 70;//35
    private static int FONT_SIZE = 40; //字符大小20
    ...
    private static void drawRands(Graphics g, char[] rands) {
        ...
        for (int i = 0; i < rands.length; i++) {
            ...
            g.drawString("" + rands[i], i * FONT_SIZE + 10, 50);//35-->25  ,  70-->50
        }
    }
